...
def __initialize_dictionary(digit=True, upper=True, lower=True):
    dictionary = []
    if digit:
        for index in range(48,58):
            dictionary.append(chr(index))
...
def generate_captcha_dataset(target_dir='generate data', n_samples=1000, length=0, font_number=1, save_pkl = True):
    ...
    def generate_captcha():
        ...
        dataset.append((image,label.lower()))
